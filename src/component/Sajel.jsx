    ...
    <div className="flex flex-col m-4 md:m-10 md:flex-row p-4 md:p-6 bg-white">
      <div className="border-y-4 ml-2 md:ml-8 md:w-1/3 grid grid-cols-2 gap-2 md:gap-4">
        <div className="col-span-2 md:col-span-1 p-2">
          <img src="https://th.bing.com/th/id/R.ca2d4df7cce917df179d6ffe62e2695b?rik=IwWI%2b4xTLw9RzA&riu=http%3a%2f%2fwww.turkpress.co%2fsites%2fdefault%2ffiles%2fthumbs_b2_40c2fa00d6b02d8d920ef7ffa73083dd_0.jpg&ehk=9YdV%2fM2L6Ht6EjxZ6PNQC7ZyhS0S2kKuFeG01vQtzgI%3d&risl=&pid=ImgRaw&r=0" alt="Donation 1" className="w-full h-full object-cover rounded-lg shadow-md" />
        </div>
        <div className="col-span-2 md:col-span-1 p-2">
      ...
      <div className="mt-4 md:mt-0 md:ml-10 md:w-1/2 flex flex-col items-start justify-center p-4 md:p-6 md:text-left md:mr-6">
        ...
        From this, we seek to establish cooperative communities,
         and its programs are summarized in the formation of local associations that work to obtain surplus for the benefit of individuals. 
        </p>
